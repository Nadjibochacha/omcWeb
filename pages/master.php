...
<?php if ($_GET['branch'] === 'sdsim1') { ?>
    ...
    <section id="timeTables">
      ...
      <div class="timeT ">
        <?php if ($_GET['branch'] === 'sitwm1') { ?>
          <h1 class="title">time slot of sitwm1 branch</h1>
        <?php } ?>
        <?php if ($_GET['branch'] === 'sitwm2') { ?>
          <h1 class="title">time slot of sitwm2 branch</h1>
        <?php } ?>
        <?php if ($_GET['branch'] === 'glm1') { ?>
          <h1 class="title">time slot of glm1 branch</h1>
        <?php } ?>
        <?php if ($_GET['branch'] === 'glm2') { ?>
          <h1 class="title">time slot of glm2 branch</h1>
        <?php } ?>
        <?php if ($_GET['branch'] === 'itsim1') { ?>
          <h1 class="title">time slot of itsim1 branch</h1>
        <?php } ?>
        <?php if ($_GET['branch'] === 'sdsim1') { ?>
          <h1 class="title">time slot of sdsim1 branch</h1>
        <?php } ?> 
        <table class="table">
          <thead>
            <tr>
